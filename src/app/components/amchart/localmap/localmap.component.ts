...
import am4geodata_worldLow from "@amcharts/amcharts4-geodata/indonesiaLow";
...
export class LocalmapComponent implements AfterViewInit, OnDestroy {

  @ViewChild("mapLocal", { static: true })
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      ...
      imageSeries.mapImages.template.tooltipText = "[font-size: 11px]{description}";
      ...
      this.apiService.getDataApi('getDistributionLocal').subscribe(response => {
